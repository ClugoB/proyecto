...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-11-2024 a las 13:55:39
...
--
-- Base de datos: `ministeriomujer`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `cargos_ayudantes`
--

CREATE TABLE `cargos_ayudantes` (
  `id` int(11) NOT NULL,
  `cargo` varchar(255) COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

--
-- Volcado de datos para la tabla `cargos_ayudantes`
--

INSERT INTO `cargos_ayudantes` (`id`, `cargo`) VALUES
(1, 'Ayudante'),
(2, 'Obrero'),
(3, 'Profesor'),
(4, 'Logística'),
...
--
-- Estructura de tabla para la tabla `codigos_operadoras`
--

CREATE TABLE `codigos_operadoras` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `codigos_operadoras`
--

INSERT INTO `codigos_operadoras` (`id`, `codigo`, `descripcion`) VALUES
(1, '0412', 'Digitel'),
(2, '0414', 'Movistar'),
(3, '0424', 'Movistar'),
(4, '0426', 'Movilnet'),
...
(2, 'Comuna Chávez Frías'),
(3, 'Concejo Comunal Cacique Guaicaipuro');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `datos_ayudantes`
--

CREATE TABLE `datos_ayudantes` (
  `id` int(11) NOT NULL,
  `nombre_apellido` varchar(255) COLLATE utf8_spanish_ci NOT NULL,
  `descripcion_cargo` varchar(255) COLLATE utf8_spanish_ci NOT NULL,
  `num_id` varchar(50) COLLATE utf8_spanish_ci NOT NULL,
  ...
  `parroquia` varchar(100) COLLATE utf8_spanish_ci DEFAULT NULL,
  `encinta` varchar(3) COLLATE utf8_spanish_ci DEFAULT NULL,
  `tiempo_encinta` int(11) DEFAULT NULL,
  `discapacidad` varchar(3) COLLATE utf8_spanish_ci DEFAULT NULL,
  `tipo_discapacidad` varchar(100) COLLATE utf8_spanish_ci DEFAULT NULL,
  `genero` varchar(10) COLLATE utf8_spanish_ci DEFAULT NULL,
  `tipo_genero` varchar(10) COLLATE utf8_spanish_ci DEFAULT NULL,
...
CREATE TABLE `encuesta` (
  ...
  `pregunta1` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta2` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta3` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta4` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta5` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta6` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta7` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta8` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta9` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta10` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta11` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta12` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta13` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta14` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta15` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta16` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta17` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta18` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta19` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta20` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta21` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta22` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta23` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta24` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta25` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta26` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta27` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta28` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta29` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta30` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta31` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta32` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta33` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta34` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta35` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta36` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta37` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta38` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta39` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta40` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta41` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta42` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta43` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta44` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta45` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta46` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta47` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta48` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta49` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta50` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta51` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta52` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta53` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta54` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta55` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta56` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta57` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta58` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta59` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta60` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta61` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta62` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta63` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta64` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta65` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta66` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta67` mediumtext COLLATE utf8mb4_unicode_ci,
  `pregunta68` mediumtext COLLATE utf8mb4_unicode_ci,
...
INSERT INTO `encuesta` (`id`, `nombre_usuario`, `pregunta1`, `pregunta2`, `pregunta3`, `pregunta4`, `pregunta5`, `pregunta6`, `pregunta7`, `pregunta8`, `pregunta9`, `pregunta10`, `pregunta11`, `pregunta12`, `pregunta13`, `pregunta14`, `pregunta15`, `pregunta16`, `pregunta17`, `pregunta18`, `pregunta19`, `pregunta20`, `pregunta21`, `pregunta22`, `pregunta23`, `pregunta24`, `pregunta25`, `pregunta26`, `pregunta27`, `pregunta28`, `pregunta29`, `pregunta30`, `pregunta31`, `pregunta32`, `pregunta33`, `pregunta34`, `pregunta35`, `pregunta36`, `pregunta37`, `pregunta38`, `pregunta39`, `pregunta40`, `pregunta41`, `pregunta42`, `pregunta43`, `pregunta44`, `pregunta45`, `pregunta46`, `pregunta47`, `pregunta48`, `pregunta49`, `pregunta50`, `pregunta51`, `pregunta52`, `pregunta53`, `pregunta54`, `pregunta55`, `pregunta56`, `pregunta57`, `pregunta58`, `pregunta59`, `pregunta60`, `pregunta61`, `pregunta62`, `pregunta63`, `pregunta64`, `pregunta65`, `pregunta66`, `pregunta67`, `pregunta68`, `fecha_ingresado`) VALUES
(7, 'adminsuper', 'Sí', 'Sí', 'assdsad', 'adwad', 'adwads', 'No', 'Sí', 'Sí', 'Sí', 'Sí', 'adwad', 'Sí', 'adwas', 'wdasd', 'No', 'Sí', 'asdwad', 'adadawds', 'Sí', 'No', 'dadsa', 'wdasdsa', 'dwdasa', 'Sí', 'adsda', 'adwas', 'asdadwa', 'Sí', 'Sí', 'Sí', 'No', 'Sí', 'dawdsa', 'dwadsa', 'No', 'Sí', 'dawdsda', 'Sí', 'Sí', 'Sí', 'Sí', 'Sí', 'Sí', 'Sí', 'Sí', 'Sí', 'awdasd', 'Sí', 'Sí', 'dawds', 'wdas', 'Sí', 'dawdsad', 'dawsa', 'Sí', 'Sí', 'daasda', 'asdwads', 'No', 'dasdad', 'asdad', 'dwdas', 'Sí', 'Sí', 'Sí', 'sadwad', 'Sí', 'ssadasd', '2024-11-17 19:08:28'),
(8, 'usuario', 'Sí', 'Sí', 'sadwa', 'dawdas', 'dawdsa', 'No', 'No', 'No', 'Sí', 'Sí', 'dsadwads', 'No', 'adasda', 'awdsaaw', 'No', 'No', 'dwadsadw', 'adwasdd', 'No', 'Sí', 'dwasaw', 'daws', 'awdas', 'Sí', 'dwawds', 'dwasa', 'dawas', 'No', 'Sí', 'Sí', 'Sí', 'Sí', 'dwadsd', 'adwsa', 'Sí', 'Sí', 'dawdaas', 'Sí', 'Sí', 'Sí', 'No', 'Sí', 'Sí', 'Sí', 'Sí', 'No', 'dwasdwad', 'Sí', 'Sí', 'wadsd', 'dawds', 'Sí', 'dwadsad', 'dwads', 'Sí', 'Sí', 'wdasd', 'dwads', 'Sí', 'wdawds', 'daws', 'dawds', 'Sí', 'Sí', 'Sí', 'dasds', 'Sí', 'as', '2024-11-17 19:10:42');
...
--
-- Estructura de tabla para la tabla `form_mujeres`
--

CREATE TABLE `form_mujeres` (
  `id` int(11) NOT NULL,
  `nombre_movimiento` varchar(255) COLLATE utf8_spanish_ci NOT NULL,
  `descripcion_movimiento` varchar(100) COLLATE utf8_spanish_ci DEFAULT NULL,
  `ciudad_ubicado` varchar(100) COLLATE utf8_spanish_ci DEFAULT NULL,
  `estado_ubicado` varchar(100) COLLATE utf8_spanish_ci DEFAULT NULL,
  `municipio_ubicado` varchar(100) COLLATE utf8_spanish_ci DEFAULT NULL,
  `parroquia_ubicado` varchar(100) COLLATE utf8_spanish_ci DEFAULT NULL,
  `estados_presentes` varchar(100) COLLATE utf8_spanish_ci DEFAULT NULL,
  `movimiento_tipo` varchar(100) COLLATE utf8_spanish_ci DEFAULT NULL,
  `nombre_lider` varchar(100) COLLATE utf8_spanish_ci DEFAULT NULL,
  `apellido_lider` varchar(100) COLLATE utf8_spanish_ci DEFAULT NULL,
  `num_id_lider` varchar(5) COLLATE utf8_spanish_ci DEFAULT NULL,
  `cedula_lider` varchar(15) COLLATE utf8_spanish_ci DEFAULT NULL,
  `codigo_lider` varchar(50) COLLATE utf8_spanish_ci DEFAULT NULL,
  `numero_telefono_lider` varchar(15) COLLATE utf8_spanish_ci DEFAULT NULL,
  `fecha_nacimiento_lider` date DEFAULT NULL,
  `correo_lider` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `nombre_apellido_ayudantes` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `num_id_ayudantes` varchar(5) COLLATE utf8_spanish_ci DEFAULT NULL,
  `cedula_ayudantes` varchar(15) COLLATE utf8_spanish_ci DEFAULT NULL,
  `descripcion_cargo_ayudantes` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `cantidad_hombres` int(11) DEFAULT '0',
  `cantidad_mujeres` int(11) DEFAULT '0',
  `fecha_registro` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `contrasena_movimiento` varchar(255) COLLATE utf8_spanish_ci NOT NULL,
  `razon_movimiento` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `tipos_movimientos` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
--
-- Estructura de tabla para la tabla `num_identidad`
--

CREATE TABLE `num_identidad` (
  `id` int(11) NOT NULL,
  `identidad` varchar(3) COLLATE utf8_spanish_ci NOT NULL,
  `descripcion` varchar(255) COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

--
-- Volcado de datos para la tabla `num_identidad`
--

INSERT INTO `num_identidad` (`id`, `identidad`, `descripcion`) VALUES
(1, 'V', 'Venezolano'),
(2, 'E', 'Extranjero'),
(3, 'J', 'Juridico'),
(4, 'G', 'Gubernamental');
...
CREATE TABLE `permisos` (
  ...
  `permiso` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
(4, 1, 'editar_usuarios'),
(5, 1, 'crear_usuarios'),
(6, 1, 'crear_movimientos'),
(7, 2, 'ver_panel'),
(8, 2, 'ver_usuarios'),
(9, 2, 'ver_graficas'),
(10, 2, 'crear_movimientos'),
(11, 3, 'ver_panel'),
(12, 3, 'crear_movimientos'),
(13, 4, 'ver_panel');
...
(1, '¿Cuál es tu ciudad natal?'),
(2, '¿Cuál es el nombre de tu primera mascota?'),
(3, '¿Cuál es el nombre de tu abuela materna?'),
(4, '¿Cuál es el nombre de tu primer profesor?'),
(5, '¿Cuál es el nombre de tu mejor amigo de la infancia?'),
(6, '¿Cuál es el nombre de tu equipo deportivo favorito?'),
(7, '¿Cuál es el nombre de tu libro favorito?'),
(8, '¿Cuál es el nombre de tu película favorita?'),
(9, '¿Cuál es el nombre de tu música favorita?'),
(10, '¿Cuál es el nombre de tu lugar favorito para viajar?');
...
--
-- Estructura de tabla para la tabla `tipos_discapacidades`
--

CREATE TABLE `tipos_discapacidades` (
  `id` int(11) NOT NULL,
  `tipo_discapacidad` varchar(255) COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `tipos_discapacidades` (`id`, `tipo_discapacidad`) VALUES
...
(8, 'Discapacidad del aprendizaje'),
...
CREATE TABLE `tipo_movimiento` (
  `id` int(11) NOT NULL,
  `tipos_movimientos` varchar(255) COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `tipo_movimiento` (`id`, `tipos_movimientos`) VALUES
(1, 'Movimiento Deportivo'),
(2, 'Movimiento Salud'),
(3, 'Movimiento Apoyo'),
(4, 'Movimiento Cultural'),
(5, 'Movimiento Social'),
(6, 'Movimiento Educativo'),
(7, 'Movimiento Ambiental'),
(8, 'Movimiento Económico'),
(9, 'Movimiento Artístico'),
(10, 'Movimiento Tecnológico');
...
CREATE TABLE `usuarios` (
  ...
  `num_id` varchar(11) COLLATE utf8_spanish_ci DEFAULT NULL,
  ...
  `respuesta_seguridad` varchar(255) COLLATE utf8_spanish_ci NOT NULL,
  `pregunta_seguridad` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
...
INSERT INTO `usuarios` (`id`, `nombre_usuario`, `contrasena`, `correo`, `nombre`, `apellido`, `num_id`, `cedula`, `oficina`, `departamento`, `cargo`, `role_id`, `respuesta_seguridad`, `pregunta_seguridad`, `id_pregunta`) VALUES
(19, 'superadmin', '$argon2i$v=19$m=1024,t=2,p=2$dkguWkd6d25Mc2hQUmVvSA$TMKis8j+gkikWUDET65Eug28+zasvOclx2+gvg6X5TY', '', '', '', 'V', '1234111', '', '', '', 1, '1', '¿Cuál es tu ciudad natal?', 1),
(20, 'admin', '$argon2i$v=19$m=1024,t=2,p=2$ejc5eFlaSlNUOVJNc0RkQQ$TB6WU8Zm9ZSakp9WcgGdBipCc6YOQvcOloM55/bTV2w', '', '', '', 'J', '1223131', '', '', '', 2, '1', '¿Cuál es el nombre de tu primer profesor?', 4),
(21, 'usuariolider', '$argon2i$v=19$m=1024,t=2,p=2$NlQzaTdVV01zb01GNDRKeQ$SdNMBf6yCr3FuTn80mvDCb+j7MrCA9YMpKWDaWb1v28', '', '', '', 'J', '223132131', '', '', '', 3, '1', '¿Cuál es el nombre de tu libro favorito?', 7),
(22, 'usuario', '$argon2i$v=19$m=1024,t=2,p=2$bzVyVUJvQ01lR2tOQWllQw$OTtaT1IHq/9x9EUKkMJiF/7S0jw0u9JLXnnkBQQCiC4', '', '', '', 'J', '12213344', '', '', '', 4, '1', '¿Cuál es el nombre de tu película favorita?', 8);
...
--
-- Indices de la tabla `cargos_ayudantes`
--
ALTER TABLE `cargos_ayudantes`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `codigos_operadoras`
--
ALTER TABLE `codigos_operadoras`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `datos_ayudantes`
--
ALTER TABLE `datos_ayudantes`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `form_mujeres`
--
ALTER TABLE `form_mujeres`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `num_identidad`
--
ALTER TABLE `num_identidad`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `tipos_discapacidades`
--
...
--
-- AUTO_INCREMENT de la tabla `cargos_ayudantes`
--
ALTER TABLE `cargos_ayudantes`
...
--
-- AUTO_INCREMENT de la tabla `codigos_operadoras`
--
ALTER TABLE `codigos_operadoras`
...
--
-- AUTO_INCREMENT de la tabla `datos_ayudantes`
--
ALTER TABLE `datos_ayudantes`
...
--
-- AUTO_INCREMENT de la tabla `form_mujeres`
--
ALTER TABLE `form_mujeres`
...
--
-- AUTO_INCREMENT de la tabla `num_identidad`
--
ALTER TABLE `num_identidad`
...
--
-- Filtros para la tabla `datos_ayudantes`
--
ALTER TABLE `datos_ayudantes`
  ADD CONSTRAINT `fk_id_movimiento` FOREIGN KEY (`id_movimiento`) REFERENCES `form_mujeres` (`id`);
...
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `fk_id_pregunta` FOREIGN KEY (`id_pregunta`) REFERENCES `preguntas_seguridad` (`id_pregunta`),
