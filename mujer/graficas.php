...
<main>
    ...
    <div class="contenedor_botones">
        <!-- DEMOGRAFÍA -->
        <h2>Demografía</h2>
        <button class="boton-estilo" onclick="window.location.href='graficas_generos.php'">Ver Gráficas de géneros</button>
        <!-- UBICACIÓN -->
        <h2>Ubicación</h2>
        <button class="boton-estilo" onclick="window.location.href='graficas_ubicacion.php'">Ver Gráficas de género por ubicaciones</button>
        <!-- ENCUESTAS -->
        <h2>Encuestas</h2>
        <button class="boton-estilo" onclick="window.location.href='graficas_encuesta.php'">Ver Gráficas de las encuestas realizadas</button>
    </div>
</main>
</div>
<!-- SCRIPTS -->
